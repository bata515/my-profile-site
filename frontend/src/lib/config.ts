...
export const PERSONAL_INFO: PersonalInfo = {
  ...
  description: "出版業界|カフェチェーン|未経験でエンジニアに転職",
...
export const SOCIAL_LINKS: SocialLinks = {
  ...
  zenn: "https://zenn.dev/your-username",
...
export const CAREER_STEPS: CareerStep[] = [
  {
    ...
    description:
      "書籍の企画・編集・校正業務を担当。読者のニーズを深く理解し、質の高いコンテンツ制作を学ぶ。",
    icon: "📚",
  ...
  },
  {
    ...
    description:
      "店舗運営、スタッフ管理、売上管理を担当。効率的なオペレーション設計とチームマネジメントを習得。",
    icon: "☕",
  ...
  },
  {
    ...
    description:
      "未経験からJava/Spring Bootでのシステム開発に従事。基礎から実践まで幅広い開発スキルを習得。",
    icon: "💻",
  ...
  },
  {
    ...
    description:
      "自社SaaSプロダクトのバックエンド開発を担当。スケーラブルなシステム設計と開発に注力。",
    icon: "🚀",
...
export const PROJECTS: Project[] = [
  {
    ...
    name: "Portfolio Site",
    description:
      "Next.js 14とTypeScriptで構築したプロフィールサイト。Framer Motionによるアニメーションとレスポンシブデザインが特徴。",
  ...
  },
  {
    ...
    description:
      "Spring Bootで構築したRESTful API。JWT認証、データベース連携、テスト自動化を実装。",
  ...
  },
  {
    ...
    description:
      "学習進捗を管理するWebアプリケーション。進捗の可視化と目標設定機能を提供。",
...
export const SITE_METADATA: SiteMetadata = {
  ...
  description:
    "エンジニア未経験からバックエンドエンジニアへキャリアチェンジした魅力を伝える、プロフェッショナルなポートフォリオサイト。",
  keywords: [
    "バックエンドエンジニア",
    "Java",
    "Spring Boot",
